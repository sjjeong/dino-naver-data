...
class GetNaverSearchCafearticleUseCase(private val naverSearchRepository: NaverSearchRepository) {
    ...
    suspend operator fun invoke(
        ...
        naverSearchRepository.getCafearticle(clientId, clientSecret, query, display, start, sort)
}